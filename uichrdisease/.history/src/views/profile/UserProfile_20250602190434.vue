        ...
        <div class="animation-container">
          ...
          <div class="connection-lines">
            <svg width="100%" height="100%" viewBox="0 0 200 200">
              <path class="line" d="M10,100 Q50,50 100,100 T190,100" />
              <path class="line" d="M10,150 Q50,100 100,150 T190,150" />
            </svg>
          </div>
        </div>
      </div>
...
.animation-container {
  ...
  margin-left: auto;
  overflow: hidden;
  filter: drop-shadow(0 0 10px rgba(33, 150, 243, 0.3)); /* 添加整体发光效果 */
}
...
.shape {
  ...
  filter: drop-shadow(0 0 8px rgba(255, 255, 255, 0.5)); /* 添加发光效果 */
}
...
.pulse-ring {
  ...
  box-shadow: 0 0 20px rgba(33, 150, 243, 0.4); /* 添加发光效果 */
}
...
.line {
  fill: none;
  stroke: rgba(33, 150, 243, 0.4); /* 增加线条不透明度 */
  stroke-width: 3; /* 增加线条宽度 */
  stroke-dasharray: 5,5;
  animation: dash 20s linear infinite;
  filter: drop-shadow(0 0 5px rgba(33, 150, 243, 0.3)); /* 添加发光效果 */
}
...
@keyframes float {
  ...
  25% {
    transform: translateY(-15px) rotate(5deg) scale(1.1); /* 增加浮动幅度和缩放 */
  }
  50% {
    transform: translateY(0) rotate(0deg) scale(1);
  }
...
@keyframes pulse {
  ...
  50% {
    ...
    opacity: 0.6;
    box-shadow: 0 0 30px rgba(33, 150, 243, 0.6); /* 增强发光效果 */
  }
  100% {
    transform: translate(-50%, -50%) scale(0.8);
    opacity: 0.8;
...
/* 添加悬停效果 */
.profile-header:hover .shape {
  animation-duration: 4s;
  filter: brightness(1.2) drop-shadow(0 0 12px rgba(255, 255, 255, 0.6)); /* 增强悬停时的发光效果 */
}

.profile-header:hover .pulse-ring {
  animation-duration: 1.5s;
  box-shadow: 0 0 30px rgba(33, 150, 243, 0.6);
}

.profile-header:hover .line {
  animation-duration: 15s;
  stroke: rgba(33, 150, 243, 0.6); /* 增加悬停时的线条亮度 */
