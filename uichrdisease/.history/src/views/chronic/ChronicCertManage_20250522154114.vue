<template>
  <div class="chronic-cert-manage">
    ...
    <el-table :data="tableData" border style="width: 100%" v-loading="loading">
      <el-table-column prop="cardId" label="卡号" width="180" />
      <el-table-column prop="insuredName" label="参保人姓名" width="120" />
      <el-table-column prop="medicalName" label="病种名称" width="150" />
...
import { getChronicCertList, addChronicCert, updateChronicCert, deleteChronicCert } from '@/api/chronic'
