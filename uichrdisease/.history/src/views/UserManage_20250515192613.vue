<template>
  <div class="user-manage-page">
    <el-breadcrumb separator="/" class="mb-4 breadcrumb-btns">
      <el-breadcrumb-item>
        <el-button type="primary" size="small" @click="$router.push('/main')" class="breadcrumb-btn">系统管理</el-button>
      </el-breadcrumb-item>
      <el-breadcrumb-item>
        <el-button type="primary" size="small" plain @click="$router.push('/main/user-manage')" class="breadcrumb-btn">用户管理</el-button>
      </el-breadcrumb-item>
    </el-breadcrumb>
    <div class="card">
      <!-- 顶部操作区 -->
