<template>
  <div class="user-manage-page">
    <el-breadcrumb separator="/" class="mb-4 breadcrumb-btns">
      <el-breadcrumb-item>
        <el-button type="primary" size="small" @click="$router.push('/main')" class="breadcrumb-btn">
          <i class="fas fa-cog breadcrumb-icon"></i>
          系统管理
        </el-button>
      </el-breadcrumb-item>
      <el-breadcrumb-item>
        <el-button type="primary" size="small" plain @click="$router.push('/main/user-manage')" class="breadcrumb-btn">
...
.breadcrumb-btns .el-breadcrumb__item {
  display: inline-flex;
  align-items: center;
}
.breadcrumb-btn {
...
.breadcrumb-btn:hover {
  ...
  background: linear-gradient(90deg, #2563eb 0%, #4c84ff 100%);
  color: #fff;
}
.breadcrumb-btn[plain]:hover {
  background: #f0f7ff;
  color: #2563eb;
  border-color: #2563eb;
}
.breadcrumb-btn:not(:last-child) {
  margin-right: 10px;
}
.breadcrumb-icon {
  font-size: 16px;
