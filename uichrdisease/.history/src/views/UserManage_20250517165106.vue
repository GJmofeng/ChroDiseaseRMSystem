<template>
  <div class="user-manage-page">
    ...
    <!-- 添加成员弹窗 -->
    <el-dialog v-model="showAddUser" title="添加成员" width="400px" :close-on-click-modal="false">
      <el-form :model="addUserForm" :rules="addUserRules" ref="addUserFormRef" label-width="80px">
        ...
        <el-form-item label="姓名" prop="fullname">
          <el-input v-model="addUserForm.fullname" autocomplete="off" />
        </el-form-item>
        <el-form-item label="角色" prop="role">
          <el-input v-model="addUserForm.role" autocomplete="off" />
        </el-form-item>
      </el-form>
      <template #footer>
