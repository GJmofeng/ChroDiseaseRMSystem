  ...
  <div class="front-page">
    ...
    <header class="fixed w-full bg-white shadow-sm z-50">
      <nav class="container mx-auto px-4 py-4">
        <div class="flex justify-between items-center">
          <div class="text-2xl font-bold text-blue-600">慢性病报销系统</div>
    ...
    <section class="hero-section gradient-bg">
      ...
      <div class="content-container flex items-center justify-center text-center px-4">
        <div class="max-w-4xl mx-auto">
          <h1 class="text-5xl md:text-6xl font-bold mb-8 text-white">
            便捷的慢性病报销服务
          </h1>
          <p class="text-xl md:text-2xl text-white mb-12">
            让医疗报销更简单，让健康保障更贴心
          </p>
          <router-link to="/register" class="bg-white text-blue-600 px-8 py-4 rounded-lg text-lg hover:bg-gray-100 transition">
            立即开始申请
          </router-link>
        </div>
      </div>
    ...
    <section class="py-20 bg-gray-50">
      <div class="container mx-auto px-4">
        <h2 class="text-3xl font-bold text-center mb-16">我们的服务优势</h2>
        <div class="grid md:grid-cols-3 gap-8">
          ...
          <div class="feature-card bg-white p-8 rounded-xl shadow-lg text-center">
            ...
            <h3 class="text-xl font-semibold mb-4">便捷申请</h3>
          ...
          <div class="feature-card bg-white p-8 rounded-xl shadow-lg text-center">
            ...
            <h3 class="text-xl font-semibold mb-4">智能审核</h3>
          ...
          <div class="feature-card bg-white p-8 rounded-xl shadow-lg text-center">
            ...
            <h3 class="text-xl font-semibold mb-4">全程追踪</h3>
    ...
    <section class="py-20">
      <div class="container mx-auto px-4">
        <h2 class="text-3xl font-bold text-center mb-16">报销申请指南</h2>
        <div class="grid md:grid-cols-4 gap-8">
          <!-- 步骤 1 -->
          <div class="text-center">
            <div class="step-number mb-4">1</div>
            <h4 class="text-lg font-semibold mb-2">注册账号</h4>
          ...
          <div class="text-center">
            ...
            <h4 class="text-lg font-semibold mb-2">提交材料</h4>
          ...
          <div class="text-center">
            ...
            <h4 class="text-lg font-semibold mb-2">等待审核</h4>
          ...
          <div class="text-center">
            ...
            <h4 class="text-lg font-semibold mb-2">完成报销</h4>
