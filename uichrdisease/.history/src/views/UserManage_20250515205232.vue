        ...
        <el-table-column label="操作" fixed="right" min-width="220" align="center">
          <template #default="scope">
            <div class="action-row">
              <span class="table-action" @click="onEdit(scope.row)">编辑</span>
              <span class="table-action" @click="onResetPwd(scope.row)">重置密码</span>
              <span class="table-action" @click="onDisable(scope.row)">禁用</span>
            </div>
          </template>
        </el-table-column>
      </el-table>
