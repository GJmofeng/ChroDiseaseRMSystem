        ...
        <el-table-column label="操作" fixed="right" min-width="220" align="center">
          <template #default="scope">
            <div class="action-row">
              <el-button class="action-btn edit" circle size="small" @click="onEdit(scope.row)">
                <i class="fas fa-edit"></i>
              </el-button>
              <el-button class="action-btn reset" circle size="small" @click="onResetPwd(scope.row)">
                <i class="fas fa-key"></i>
              </el-button>
              <el-button class="action-btn disable" circle size="small" @click="onDisable(scope.row)">
