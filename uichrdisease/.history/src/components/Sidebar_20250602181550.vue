  ...
  <div class="sidebar neumorphic" :class="{ collapsed: isCollapsed }">
    ...
    <div class="menu-section">
      ...
      <div class="menu-group" :class="{ collapsed: !menuStates.system }">
        ...
        <div class="menu-item" :class="{ active: isActive('/main/policy-manage') }" @click="router.push('/main/policy-manage')">
    ...
    <div class="menu-section">
      ...
      <div class="menu-group" :class="{ collapsed: !menuStates.business }">
        ...
        <div class="menu-item" :class="{ active: isActive('/main/reimbursement-form') }" @click="router.push('/main/reimbursement-form')">
          <i class="fas fa-money-check-alt"></i>
          <span v-show="!isCollapsed">参合缴费登记</span>
        </div>
        <div class="menu-item" :class="{ active: isActive('/main/reimbursement-list') }" @click="router.push('/main/reimbursement-list')">
          <i class="fas fa-file-invoice-dollar"></i>
          <span v-show="!isCollapsed">报销记录</span>
        </div>
        <div class="menu-item" :class="{ active: isActive('/main/reimbursement-audit') }" @click="router.push('/main/reimbursement-audit')">
          <i class="fas fa-clipboard-check"></i>
          <span v-show="!isCollapsed">报销审核</span>
        </div>
        <div class="menu-item" :class="{ active: isActive('/main/reimbursement-remit') }" @click="router.push('/main/reimbursement-remit')">
    ...
    <div class="menu-section">
      ...
      <div class="menu-group" :class="{ collapsed: !menuStates.statistics }">
        <div class="menu-item" :class="{ active: isActive('/main/yearly-statistics') }" @click="router.push('/main/yearly-statistics')">
          <i class="fas fa-chart-bar"></i>
          <span v-show="!isCollapsed">按年份统计</span>
        </div>
        <div class="menu-item" :class="{ active: isActive('/main/monthly-statistics') }" @click="router.push('/main/monthly-statistics')">
    ...
    <!-- 个人中心 -->
    <div class="menu-section">
      <div class="menu-section-title" @click="toggleMenuGroup('profile')">
        <i class="fas fa-user menu-arrow" :class="{ 'collapsed': !menuStates.profile }"></i>
        <span v-show="!isCollapsed">个人中心</span>
      </div>
      <div class="menu-group" :class="{ collapsed: !menuStates.profile }">
        <div class="menu-item" :class="{ active: isActive('/main/user-profile') }" @click="router.push('/main/user-profile')">
          <i class="fas fa-id-card"></i>
          <span v-show="!isCollapsed">个人资料</span>
        </div>
      </div>
    </div>
